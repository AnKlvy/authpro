    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            ...
            <a class="nav-link active" aria-current="page" href="/cart">
                <object data="../../../storage/app/public/localimages/svg/shopping-cart-outline-svgrepo-com.svg"
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @else
                        @if(Auth::user()->isAdmin())
                            ...
                            <li><a class="nav-link active" aria-current="page" href="/p3">For developer</a></li>
                        @endif
